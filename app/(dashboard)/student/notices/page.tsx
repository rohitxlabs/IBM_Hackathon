...
export default function StudentNoticesPage() {
  ...
  const typeColors: Record<string, string> = {
    ...
    attendance: "bg-secondary-100 text-secondary-600",
    announcement: "bg-warning-100 text-warning-600",
    message: "bg-accent-100 text-accent-600",
  };
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">View all your notifications and announcements</p>
      </div>
